  ...
  return (
    <div className="container h-screen flex">
      ...
      <div className="basis-[60%] flex flex-col justify-center items-center">
        <div>
          <h1 className="text-[4rem] mb-4 tracking-tighter font-semibold text-[#094470] font-['Volkhov'] leading-tight">
            Mauj Punjab di ab Jaipur vich
          </h1>
          <p className="text-[1.6rem]">
            Experience all things fun revolving around the culture and heritage
            of Punjab- Baisakhi, Lohri, Food and more!
          </p>
        </div>
        <div className="w-full h-[60%] py-4 flex justify-between items-center gap-4">
          <div className="w-[33.33%] h-full border-2">
            <video className="h-full" autoplay loop muted plays-inline>
